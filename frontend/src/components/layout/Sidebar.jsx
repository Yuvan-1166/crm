...
const WORKSPACE_ITEMS = [
  ...
  { id: 'ab-tests', path: '/ab-tests', icon: FlaskConical, label: 'A/B Tests' },
...
const Sidebar = memo(({ activeStage, onStageChange, collapsed, onToggle, isAdmin = false }) => {
  ...
  const { currentViewMode, currentStage, currentWorkspaceView, currentAdminView, isAdminRoute } = useMemo(() => {
    ...
    if (path.startsWith('/admin/ab-tests')) return { currentViewMode: null, currentStage: null, currentWorkspaceView: 'ab-tests', currentAdminView: null, isAdminRoute: true };
    ...
    if (path.startsWith('/ab-tests')) return { currentViewMode: null, currentStage: null, currentWorkspaceView: 'ab-tests', currentAdminView: null, isAdminRoute: false };
